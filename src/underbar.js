  ...
  _.uniq = function (array, isSorted, iterator) {
    ...
    _.each(array, function (value, key, collection) {
      if (iterator) {
        ...
        //check if the value returned by iterator exists in arraytwo
        // if so, pass the value into newArray, 
        // take the value that iterator returns and push into arraytwo

        if (!arraytwo.includes(iterator(value))) {
          newArray.push(value)
          arraytwo.push(iterator(value))
        }
